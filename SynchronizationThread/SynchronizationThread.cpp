...
// SynchronizationThread.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSynchronizationThreadApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSynchronizationThreadApp

CSynchronizationThreadApp::CSynchronizationThreadApp()
{
...
// Единственный объект CSynchronizationThreadApp

CSynchronizationThreadApp theApp;


// Инициализация CSynchronizationThreadApp

BOOL CSynchronizationThreadApp::InitInstance()
{
